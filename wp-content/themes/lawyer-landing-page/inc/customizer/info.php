...
function lawyer_landing_page_customizer_theme_info( $wp_customize ) {
    ...
    $theme_info = '';
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Video Tutorial: ', 'lawyer-landing-page' ) . '</label><a href="' . esc_url( 'https://raratheme.com/documentation/lawyer-landing-page/' ) . '" target="_blank">' . __( 'here', 'lawyer-landing-page' ) . '</a></span><br />';
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Theme Demo: ', 'lawyer-landing-page' ) . '</label><a href="' . esc_url( 'https://raratheme.com/previews/?theme=lawyer-landing-page' ) . '" target="_blank">' . __( 'here', 'lawyer-landing-page' ) . '</a></span><br />';
