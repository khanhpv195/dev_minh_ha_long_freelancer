  ...
  $upload_dir = wp_upload_dir();
    return array(
        array(
            ...
            'local_import_file'            => $upload_dir['basedir'] . '/rara-demo-pack/lawyer-landing-page-demo-content/content/lawyer.xml',
            'local_import_widget_file'     => $upload_dir['basedir'] . '/rara-demo-pack/lawyer-landing-page-demo-content/content/lawyer.wie',
            'local_import_customizer_file' => $upload_dir['basedir'] . '/rara-demo-pack/lawyer-landing-page-demo-content/content/lawyer.dat',
